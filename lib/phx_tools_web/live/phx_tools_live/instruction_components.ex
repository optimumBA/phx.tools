    ...
    <div class="solved-height font-normal">
      <div class="w-full h-full flex items-center justify-center">
        <div class="block lg:mt-[3%] ">
          ...
          <div class="h-full w-full border-4 hover:border-2 shadow-[#28177E] shadow-md border-[#211666] hover:border-indigo-450 rounded-md lg:mx-[2%] pb-2">
            <div class="text-start px-[3%] lg:text-xl md:text-lg sm:text-md">
              ...
              <div class="flex items-center justify-evenly border border-indigo-450 py-1 mx-[4%] lg:mt-6 md:mt-5 sm:mt-4 rounded-lg">
