  ...
  def unsupported_os_page(assigns) do
    ...
    <div class="flex flex-col items-center max-w-5xl mx-auto">
      <div class="md:w-11/12 lg:w-[65%]">
        ...
        <div class="bg-[#110A33] rounded-xl shadow-lg text-white shadow-[#2C2650] blur-shadow ">
          <div class="bg-[#2C2650] sm:p-3 rounded-t-xl md:flex items-center md:space-x-4 justify-center">
            <Icons.exclamation_icon />
            <p class="font-martian text-[16px]">Unsupported Operating System Detected</p>
          </div>
          <p class="sm:text-sm sm:leading-6 md:text-sm text-center sm:px-3  font-martian sm:py-6 ">
      ...
      <div class="md:w-10/12 lg:w-[90%]">
        ...
        <p class="text-white font-martian text-center sm:text-sm sm:pb-4 ">
